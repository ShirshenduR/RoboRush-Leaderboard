...
export default function AdminDashboard() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[80vh]">
        ...
        >
          <div className="w-16 h-16 border-4 border-neon-yellow border-t-transparent rounded-full animate-spin" />
  ...
  return (
    <div className="min-h-screen px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
      ...
      </AnimatePresence>          Tip: Copy team names from Excel/Sheets and paste here
                </p>
              </div>
              <div className="flex gap-2">
                <button
